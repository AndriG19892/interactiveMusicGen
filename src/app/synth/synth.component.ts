...
export class SynthComponent implements OnInit {
  ...
  @Input('isSynthShown') public isInstrumentShown : boolean;
...
// custom order of phrases
  for (var _i = 0; _i < this.numberOfPhrasesInPart_CustomOrderOfPhrases; _i++) {
    ...
    // TEST
    console.log("melodic seed for each pattern in phrase " + _i + "\n\t" + this.melodicSeedForEachPattern[this.phrasesInCustomOrderOfPhrasesArray[_i]])
