...
@Component({
  selector: 'app-fm-synth',
  templateUrl: './fm-synth.component.html',
  styleUrls: ['./fm-synth.component.css'],
  encapsulation: ViewEncapsulation.ShadowDom
})
export class FmSynthComponent implements OnInit {
...
//console.log("release = " + this.synth.envelope.release);
  ...
  onWaveformSelected(event) {
    ...
    console.log("FM SYNTH waveform = " + this.synth.oscillator.type);
 }
 onModulatorWaveformSelected(event) {
  this.synth.modulation.type = event.target.value;
  console.log("FM SYNTH modulator waveform = " + this.synth.modulation.type);
}
 ...
 onPanChange(event) {
  ...
  //console.log("FM SYNTH pan = " + this.panner.pan.value);
}
 onSyncChange(event) {
...
onPartPlay(synth) {
  ...
  // copying back the settings of the last Part object into the new one
   ...
   this.part.start();
   console.log("FM SYNTH part " + this.part.state);
   }
